...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Fresh Produce Catalog | RafRaf International',
        description: 'B2B wholesale fresh produce from India: onions, bananas, pomegranates, chillies & more. Export-ready for UAE and Gulf markets.',
        url: 'https://www.rafraf.org/produce',
    },
};
