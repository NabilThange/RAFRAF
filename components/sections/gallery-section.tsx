...
export function GallerySection() {
  ...
  return (
    ...
    >
      {/* Sticky container */}
      <div className="sticky top-0 h-screen overflow-hidden flex items-center justify-center px-3 sm:px-4">
        <div className="relative w-full max-w-5xl h-[60vh] sm:h-[70vh] md:h-[80vh]">
          {images.map((image, index) => {
            ...
            return (
              ...
              >
                <div 
                  className="relative w-full h-full overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl"
                  style={{
